...
export default {
  data: () => ({
    ...
    userSelfIntrodction:
      "我是尼古拉斯·赵四！尼古拉斯赵四是世界著名的舞蹈艺术家！著名的蹬腿舞就是由他所创。蹬腿舞以抽搐，两腿乱蹬，目光呆滞，五指伸直为特点，完美的体现了癫痫式的美感！如今，蹬腿舞者已经遍布世界各地。在贫困的非洲大地，缺少娱乐设施的贫穷儿童和少年们，平时就以蹬腿舞为娱乐活动，在某种程度上，蹬腿舞给他们带来的并不只是娱乐，而在精神上给予极大的鼓舞。所以尼古拉斯赵四的贡献是巨大的。舞蹈界第一人！所以说亚洲舞王这个称号还不能概括他为整个世界做出的贡献。如果一定要给他一个称号，我觉得应该是:宇宙舞王！！！！"
  })
};
</script>
<style>
